  ...
  const handleDeletePost = () => {
    swal({
      ...
      if (btnAction) {
        ...
        if (result.data) {
          dispatch(
            alertt_success("You have just successfully deleted this post")
          );
          navigate("/home");
        }
      } else {
    ...
    swal({
      ...
      if (btnAction) {
        ...
        if (result.data) {
          ...
          dispatch(
            alertt_success("You have just successfully deleted this comment")
          );
        } else {
          dispatch(backDropOFF());
        }
  ...
  return (
    ...
    >
      ...
      <img
        src={
          data.image
            ? `${process.env.REACT_APP_POSTS_IMAGE_FOLDER}` + data.image
            : ""
        }
        alt=""
      />
      ...
      >
        ...
        <form className="infoForm" action="">
          ...
          <button className="button infoButton" onClick={handleUpdatePost}>
            Update
          </button>
        </form>
      </Modal>
