            ...
            {notification.type === NOTIFICATIONTYPES.ADD_CONTACT ? (
                <div onClick={() => sendToProfile(notification.idSender)}>
                    ...
                    <div className="notif-title">
                        <span>
                            {notification.firstNameSender} just sent a friend
                            request.
                        </span>
                ...
                <div>
                    ...
                    <div className="notif-title">
                        <span>
                            {notification.firstNameSender} accepted your friend
                            request.
                        </span>
                        <span className="notif-time">
                            {convertTimestampToHumanTime(notification.createAt)}
                ...
                <div>
                    ...
                    <div className="notif-title">
                        <span>
                            {notification.firstNameSender} mentioned you in a
                            comment.
                        </span>
                        <span className="notif-time">
                            {convertTimestampToHumanTime(notification.createAt)}
                ...
                <div>
                    ...
                    <div className="notif-title">
                        <span>
                            Congratulations, you have successfully registered an
                            account. Please activate your account.....
                        </span>
                        <span className="notif-time">
                            {convertTimestampToHumanTime(notification.createAt)}
                        </span>
